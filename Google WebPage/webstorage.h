...
public:
	...
	std::set<std::string> union_webpages(std::set<std::string> partial_webpages,std::set<std::string> resulting_webpages);
	...
	void execute_query(std::set<std::string> &find_words, std::ofstream& out_file);
